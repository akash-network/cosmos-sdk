...
func AddQueryFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().String(FlagGRPCNode, "http://localhost:9090", "http(s)://<host>:<port> to GRPC interface for this chain")
	cmd.Flags().Duration(FlagGRPCKeepAlive, 20*time.Second, "")
